...
function bbrDrawWorldBadge(i,t,e,n,s,r){
  i.save();let a=i.createRadialGradient(t-n*.3,e-n*.35,n*.08,t,e,n);a.addColorStop(0,"rgba(255,255,255,.72)"),a.addColorStop(.28,r.badge),a.addColorStop(1,r.deep),i.fillStyle=a,i.beginPath(),i.arc(t,e,n,0,Math.PI*2),i.fill(),i.strokeStyle=r.accent,i.globalAlpha=.98,i.lineWidth=3.4,i.stroke(),i.globalAlpha=.68,i.strokeStyle=r.primary,i.lineWidth=1.5,i.beginPath(),i.arc(t,e,n*.78,0,Math.PI*2),i.stroke(),i.globalAlpha=1,i.fillStyle=r.ink,i.font="800 "+(s>9?54:62)+"px Arial, sans-serif",i.textAlign="center",i.textBaseline="middle",i.fillText(String(s),t,e+2),i.restore()
}
