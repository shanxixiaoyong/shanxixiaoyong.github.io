...
function Cm(i,t,e,n,s){
  let{canvas:r,context:a}=Jc(i,zi,Yn),o=e>8,c="#f5f0e7";
  if(a.imageSmoothingEnabled=!0,a.fillStyle=e===0||o?c:n,a.fillRect(0,0,zi,Yn),o){let h=Math.round(Yn*.305),g=Math.round(Yn*.39);a.fillStyle=n,a.fillRect(0,h,zi,g)}
  if(e===0){a.fillStyle="#9f3e43";for(let h of[.25,.75])a.beginPath(),a.arc(zi*h,Yn*.5,5.5,0,Math.PI*2),a.fill()}
  else{
    let h=s.enabled?s.assignments[e]:null;
    if(h)for(let g of[.25,.75])bbrDrawMotif(a,zi*g,Yn*.658,h,s);
    let g=Yn*.096;
    Yc(a,zi*.25,Yn*.5,g,e),Yc(a,zi*.75,Yn*.5,g,e);
  }
  let l=new ns(r);
